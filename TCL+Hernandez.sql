...
DELETE FROM Clients WHERE ClientID IN (1, 2, 3);

START TRANSACTION;

INSERT INTO Clients (ClientID, Name, Last_Name, GovID, Dob, Country_of_Domicile, Email, Risk_Profile, balance)
VALUES (11, 'andres', 'rosal', 1234567890, '1990-01-01', 'USA', 'john.doe@example.com', 'Low Risk', 1000),
       (12, 'julieta', 'paz', 0987654321, '1985-05-10', 'Canada', 'jane.smith@example.com', 'Medium Risk', 2000);

START TRANSACTION;

INSERT INTO Investment_Order (OrderID, PortfolioID, ClientID, OrderDate, Order_Status, Order_Amount)
VALUES (13, 1, 1, '2023-01-01', 'Pending', 1000.0),
       (14, 1, 2, '2023-01-02', 'Completed', 2000.0),
       (15, 2, 1, '2023-01-03', 'Pending', 1500.0);
